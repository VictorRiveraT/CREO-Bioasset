...
|                 | `Estado`| `string`     | No       | |
|                 | `FechaAdquisicion`| `string?` | Sí | *Inconsistencia de tipo* (Debería ser DateTime o DateOnly). |
|                 | `ProximoMantenimiento`| `string?`| Sí | *Inconsistencia de tipo*. |
...
|                 | `Fecha` | `string`     | No       | *Inconsistencia de tipo*. |
...
|                 | `Tipo`  | `string`     | No       | |
|                 | `Estado`| `string`     | No       | |
|                 | `ProximaFecha`| `string?`| Sí | *Inconsistencia de tipo*. Mapeado a `proxima_fecha`. |
