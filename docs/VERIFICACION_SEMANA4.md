...
\\\
*Nota:* Hubo que corregir un detalle con EnsureCreated() en .NET, ya que si uth-service inicializaba la BD primero, inventario-service no creaba sus tablas. Se solucionó añadiendo CreateTables(). Todo levanta correctamente.
...
*Evidencia de la BD SQL Server (docker exec ... sqlcmd -Q "SELECT top 1 id, nombre FROM bioasset.inventario.Activos"):*
\\\
id                                   nombre                                                                                                                                                                                                                                                           
------------------------------------ ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
...
*Respuesta parcial (comienza con el tag base64 y los bytes del header PNG):*
\\\
